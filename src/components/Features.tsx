...
function Features() {
  ...
  <div className="container  px-8 py-10  flex flex-wrap ">
    ...
    >
      <Image width={400} height={400} alt="feature" className=" absolute sm:mx-32 mx-4 sm:h-5/6 h-1/2 left-12 sm:left-10 sm:top-[55rem] top-[55rem] transform z-30 " src="/images/featureiphone.png"/>
      <Image width={400} height={400}
          src="/images/circlehero.png"
          alt="iPhone 3"
          className="absolute top-[54rem] sm:left-8 -left-2 w-full sm:w-1/3 transform  z-20"
    ...
    <Image width={100} height={100} className="left-[80rem] absolute rotate-[25deg]  w-12 sm:visible invisible " src="/images/star1.png" alt="" />
